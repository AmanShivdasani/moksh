...
diabetes_model = pickle.load(open('Model/savedmodels/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open('Model/savedmodels/heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open('Model/savedmodels/parkinsons_model.sav', 'rb'))
...
if (selected == 'Diabetes Prediction'): 
    ...
    try:
        ...
        st.success("Please enter all values and make sure all values are correct")
        print("error")
...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv(r'Model/dataset/Training.csv')
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv(r'Model/dataset/Testing.csv')
...
medicine_dictionary = {
    ...
    "Hypothyroidism": ["Immediate checkup and treatment required"],
    "Jaundice": ["Live 52 DS"],
    "Hypoglycemia": ["Immediate checkup and treatment required"],
    ...
    "Psoriasis": ["Immediate checkup and treatment required"],
    "Spondylitis": ["Jogaraja Gugula", "Mahamasa Taila"],
    "Tuberculosis": ["Immediate checkup and treatment required"],
    "Typhoid": ["Immediate checkup and treatment required"],
    "Urinary Tract": ["Anyolith", "Asocaristha"],
    "Varicose Veins": ["Immediate checkup and treatment required"],
    "Alcoholic Hepatitis": ["Immediate checkup and treatment required"],
    "Cervical Spondylosis": ["Kineaz Tablets", "Rumartho Gold"],
    "Chicken Pox": ["Immediate checkup and treatment required"],
    "Chronic cholestasis": ["Sunthi Khanda Modaka", "Live 52 DS"],
    "Piles": ["Asrsakuthara Rasa", "Pilex"],
    "Drug Reaction": ["Immediate checkup and treatment required"],
    "GERD": ["Acilans Capsule"],
    "Gastroenteritis": ["Gasex Tablet", "Sunthi Khanda Modaka"],
    "Heart Attack": ["Immediate checkup and treatment required"],
    "Hepatitis A, B, C, D, E": ["Immediate checkup and treatment required"],
    "Impetigo": ["Immediate checkup and treatment required"],
    "Migraine": ["Immediate checkup and treatment required"],
...
if (selected == 'General Symptoms'):
    ...
    if st.button('Symptoms Test Result'):
        st.success(f"The verified disease is: {disease[predicted]}")
        st.info("Medicines for the predicted disease:")
        for medicine in medicines:
            st.success(f"- {medicine}")
st.title('KNOW YOUR HEALTH STatUS')